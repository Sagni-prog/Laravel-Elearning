    ...
    <div class="container-r">
        ...
        <div class="container-fluid-r">
         ...
         {{-- ***********search here starts here*************** --}}
            <form action = "search-teacher" method="POST" class="search-r" >
                @csrf
                <input type="search" class="search-input-r" name="search" id="" placeholder="Search">
                <button type="submit" class="button-search"> <i
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>
                                                <div class="" style="display: flex;gap: 1rem;">
                                                    <div class="d-flex flex-column ">
                                                        <img src="/logos/team-1.jpg"
                                                            class="avatar avatar-sm me-3 border-radius-lg" alt="user1"
                                                            width="40px" height="40px" style="border-radius: 50%;" />
                                                    </div>
                                                    <div class="d-flex flex-column">
                                                        <h6 class="mb-0 text-sm">{{$data->first_name}} {{$data->middle_name}}</h6>
                                            ...
                                            <td class="align-middle text-center" style="align-items: center;">
                                                <span class="text-secondary text-xs font-weight-bold">{{$data->phone_no}}</span>
                                            </td>

                                            <td class="align-middle text-center" style="align-items: center;">
                                                <span class="text-secondary text-xs font-weight-bold">{{$data->profession}}</span>
                                            </td>
                                            <td class="align-middle" style="align-items: center;">
                                                <a href="{{url('delete-teacher',$data->teacher_id)}}" class="text-secondary font-weight-bold text-xs"
