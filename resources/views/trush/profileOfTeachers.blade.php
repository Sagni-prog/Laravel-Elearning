      ...
      >
        <ul class="navbar-nav">
          <li class="nav-item">
            ...
            <li class="nav-item">
                <a class="nav-link text-white" href="/pages/teacherstabel.html">
                    <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
    ...
    <div class="main-content position-relative max-height-vh-100 h-100">
                ...
                <div class="row gx-4 mb-2">
                    <div class="col-auto">
                        <div class="avatar avatar-xl position-relative">
                            <img src="<?php echo $data->profile; ?>" alt="profile_image" class="w-100 border-radius-lg shadow-sm" />
                        </div>
                    </div>
                    <div class="col-auto my-auto">
                      
                        <div class="h-100">
                            <h5 class="mb-1">{{$data->first_name}} {{$data->middle_name}}</h5>
            ...
            <div class="row">
              ...
              <div class="col-12 col-xl-4">
                ...
                <div class="card-body p-3">
                    <p class="text-sm">
                        Hi, I’m {{$data->first_name}} {{$data->middle_name}}. I'm professional frontend developer with 3 years of working experience. besides that, I love teaching and educating people.
                    </p>
                    <hr class="horizontal gray-light my-4" />
                    <ul class="list-group">
                        <li class="list-group-item border-0 ps-0 pt-0 text-sm">
                            <strong class="text-dark">Full Name:</strong> &nbsp; {{$data->first_name}} {{$data->middle_name}} {{$data->last_name}}
                        </li>
                        <li class="list-group-item border-0 ps-0 text-sm">
                            <strong class="text-dark">Mobile:</strong> &nbsp; {{$data->phone_no}}
                        </li>
                        <li class="list-group-item border-0 ps-0 text-sm">
                            <strong class="text-dark">Email:</strong> &nbsp; {{$data->email}}
                        </li>
                        <li class="list-group-item border-0 ps-0 text-sm">
                            <strong class="text-dark">Location:</strong> &nbsp; Jimma, Ethiopia
                        </li>
        ...
        <div class="col-12 mt-4">
            <div class="mb-5 ps-3">
                ...
                <p class="text-sm">Website development</p>
            </div>
            <div class="row">
                <div class="col-xl-3 col-md-6 mb-xl-0 mb-4">
                    <div class="card card-blog card-plain">
                        ...
                        <div class="card-body p-3">
                            <p class="mb-0 text-sm">Course #1</p>
                            <a href="javascript:;">
                                <h5>
                            ...
                            <p class="mb-4 text-sm">
                                Structured course for begineers and professionals.
                            </p>
                ...
                <div class="col-xl-3 col-md-6 mb-xl-0 mb-4">
                    <div class="card card-blog card-plain">
                        ...
                        <div class="card-body p-3">
                            <p class="mb-0 text-sm">Course #2</p>
                            <a href="javascript:;">
                                <h5>
                            ...
                            <p class="mb-4 text-sm">
                                Master CSS with these tutorial videos.
                            </p>
                            <div class="d-flex align-items-center justify-content-between">
                                <button type="button" class="btn btn-outline-primary btn-sm mb-0">
                            View Course
                ...
                <div class="col-xl-3 col-md-6 mb-xl-0 mb-4">
                    <div class="card card-blog card-plain">
                        ...
                        <div class="card-body p-3">
                            <p class="mb-0 text-sm">Course #3</p>
                            <a href="javascript:;">
                                <h5>The Complete JavaScript and Jquery Course</h5>
                            </a>
                            <p class="mb-4 text-sm">
                                Here is All you need to know about JavaScript From Zero to Expert!
                            </p>
                            <div class="d-flex align-items-center justify-content-between">
                                <button type="button" class="btn btn-outline-primary btn-sm mb-0">
                            View Project
